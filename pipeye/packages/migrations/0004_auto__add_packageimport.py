...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PackageImport'
        db.create_table('packages_packageimport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('packages', ['PackageImport'])


    def backwards(self, orm):
        # Deleting model 'PackageImport'
        db.delete_table('packages_packageimport')
    ...
    models = {
        ...
        'packages.packageimport': {
            'Meta': {'object_name': 'PackageImport'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
